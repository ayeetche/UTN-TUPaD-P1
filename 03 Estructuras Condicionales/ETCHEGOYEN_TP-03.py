...
# %%
frase = input("Ingresar palabra/frase ")
frase_minuscula = frase.lower()

if(frase_minuscula[-1] == 'a'): 
    print(f'{frase}!')
elif(frase_minuscula[-1] == 'e'): 
    print(f'{frase}!')
elif(frase_minuscula[-1] == 'i'): 
    print(f'{frase}!')
elif(frase_minuscula[-1] == 'o'): 
    print(f'{frase}!')
elif(frase_minuscula[-1] == 'u'): 
    print(f'{frase}!')
else: 
    print(frase)
# %%
...
print('Opción 1: si queres tu nombre en mayúsculas.')
print('Opción 2: si queres tu nombre en minúsculas.')
print('Opción 3: si queres tu nombre con la primera letra mayúscula.')
...
#%%
magnitud = int(input("Ingresa la magnitud de un terremoto: "))
if(magnitud < 3):
    print("Muy leve")
...
hemisferio = input('En qué hemisferio te encontras? Ingresar: N/S ').upper()
mes = int(input('Ingresar mes del año (número) '))
dia = int(input('Ingresar día del año (número) '))
...
if(hemisferio == 'N'):
    if(dia < 1 or mes < 1): 
        ...
        print('Invierno')
    elif(mes == 3 and dia > 20 and dia <= 31):
        print('Primavera')
        ...
        print('Primavera')    
    elif(mes == 6 and dia > 20 and dia <= 30):
        print('Verano')
        ...
        print('Verano')
    elif(mes == 9 and dia > 20 and dia <= 30):
        print('Otoño')
        ...
        print('Otoño')
    elif(mes == 12 and dia > 20 and dia <= 31):
        print('Invierno')
    else:
        print('Fecha incorrecta')
elif(hemisferio == 'S'):
